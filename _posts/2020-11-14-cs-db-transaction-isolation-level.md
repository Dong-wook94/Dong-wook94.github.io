---
layout: post
title: "[데이터베이스] 트랜잭션 Isolation Level"
subtitle: "데이터베이스 트랜잭션 Isolation Level"
categories: cs
tags: cs db database transaction Isolation-Level
comments: true
---

> 잘 정리한 [블로그](https://feco.tistory.com/45)가 있어서 참고를 많이하였습니다. 

# Isolation Level이란?

[트랜잭션의 ACID](https://dong-wook94.github.io/cs/2020/11/14/cs-db-transaction/)중 Isolation과 관계가 있다
